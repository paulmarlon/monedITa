...
@section('content')
    <div class="card card-primary card-outline shadow">
        <div class="card-header">
            <h3 class="card-title">
                <i class="bi bi-pencil-square me-1"></i> Editar Periodo: {{ $ciclo->nombre }}
            </h3>
        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="nombre" id="nombre"
                                ...
                                value="{{ old('nombre', $ciclo->nombre) }}" placeholder="Ej: Periodo 1/2026" required>
                            @error('nombre')
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select name="estado" id="estado"
                                ...
                                <option value="CERRADO" {{ old('estado', $ciclo->estado) == 'CERRADO' ? 'selected' : '' }}>
                                    Cerrado</option>
                            </select>
                            @error('estado')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="fecha_inicio" id="fecha_inicio"
                                ...
                                value="{{ old('fecha_inicio', optional($ciclo->fecha_inicio)->format('Y-m-d')) }}">
                            @error('fecha_inicio')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="fecha_fin" id="fecha_fin"
                                ...
                                value="{{ old('fecha_fin', optional($ciclo->fecha_fin)->format('Y-m-d')) }}">
                            @error('fecha_fin')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
