            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="card card-primary card-outline shadow">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="bi bi-plus-circle me-1"></i> Registrar Nuevo Minijuego en el Catálogo
                        </h3>
                    </div>
                    ...
                    <form action="{{ route('juegos.store') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="titulo" id="titulo"
                                            ...
                                            value="{{ old('titulo') }}" placeholder="Ej: Dinosaurio Runner" required>
                                        @error('titulo')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="0.01" min="0" name="costo_ficha"
                                                ...
                                                value="{{ old('costo_ficha', '0.00') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="slug" id="slug"
                                            ...
                                            value="{{ old('slug') }}" placeholder="Ej: dinosaurio_runner" required>
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <textarea name="descripcion" id="descripcion" rows="2"
                                            ...
                                            placeholder="Breve descripción de las reglas o dinámica del minijuego...">{{ old('descripcion') }}</textarea>
                                        @error('descripcion')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="card-footer text-right">
                            ...
                            <button type="submit" class="btn btn-primary shadow-sm">
                                <i class="bi bi-save me-1"></i> Guardar Juego
                            </button>
                        </div>
                    </form>
                </div>
